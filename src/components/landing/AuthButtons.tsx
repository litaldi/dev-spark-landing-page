      ...
      <>
        ...
        <Button
          ...
          onClick={() => {
            ...
            window.location.href = "/auth/login?demo=true";
          }}
        >
          <span>Try Demo</span>
    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-56">
          ...
          <DropdownMenuItem onSelect={() => handleLoginClick("Google")}>
          ...
          <DropdownMenuItem onSelect={() => handleLoginClick("GitHub")}>
          ...
          <DropdownMenuItem onSelect={() => window.location.href = "/auth/login?demo=true"}>
