...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="py-20 md:py-32 bg-gradient-to-br from-brand-100 via-brand-50 to-white relative overflow-hidden" aria-labelledby="hero-heading">
      ...
      <div className="container px-4 max-w-6xl mx-auto relative">
        <div className="text-center max-w-3xl mx-auto animate-fade-up z-10">
          <h1 id="hero-heading" className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-800 mb-6 leading-tight">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            {isLoggedIn ? (
              <Button 
                size="lg" 
                className="rounded-full bg-brand-500 hover:bg-brand-600 text-white px-8 py-6 text-lg transform transition-all duration-300 hover:scale-105"
              ...
              <>
                ...
                <Button 
                  variant="outline" 
                  size="lg" 
                  className="rounded-full border-brand-300 bg-white bg-opacity-90 backdrop-blur-sm hover:bg-brand-50 px-8 py-6 text-brand-700"
